...
// - インスタンスは変数 `me` に代入する
const me = new Person('じん', 24, '男', 175, 64);

// 課題3: 課題2で生成したインスタンスの情報をconsole.logを使って、「名前」「年齢」「性別」「身長」「体重」が正しくセットされていることを確認する
console.log('me.nameはじんであるべき : ', me.name);
console.log('me.ageは24であるべき : ', me.age);
console.log('me.genderは男であるべき : ', me.gender);
console.log('me.heightは175であるべき : ', me.height);
console.log('me.weightは64であるべき : ', me.weight);
